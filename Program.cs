...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            //ensures the pet age is valid and stores it
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1] != "ID #: " && ourAnimals[i, 1] != "")
                {
            ...
            //ensures the pet physical description is valid and saves it
            for (int i = 0; i < maxPets; i++)
            {
                while (ourAnimals[i, 4] == "Physical description: " && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            ...
                            validEntry = animalPhysicalDescription.Length >= 5;
                        }
                        //put value in data
                    } while (validEntry == false);
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                while (ourAnimals[i, 3] == "Nickname: " && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
            ...
            for (int i = 0; i < maxPets; i++)
            {
                while (ourAnimals[i, 5] == "Personality: " && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            ...
                            validEntry = animalPersonalityDescription.Length >= 5;
                        }
                    } while (validEntry == false);
                    ourAnimals[i, 5] = "Personality: " + animalPersonalityDescription;
            ...
            Console.WriteLine("Nickname and Personality description are complete for all of our friends.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
